...
class wsmRequests{
    ...
    function fnSetLastHitTime(){
        if($this->fnGetParam('ping')!=1){
            update_option(WSM_PREFIX.'_lastHitTime',$this->wsmGetCurrentUTCDate());
        }
    }
    ...
    function fnHandleNewVisit(){
       // echo 'New Visit : <pre>';
        $this->fnSetVisitorProperty('firstActionVisitTime', $this->wsmGetCurrentUTCDate());
        $this->fnSetVisitorProperty('visitLastActionTime', $this->wsmGetCurrentUTCDate());
        $this->fnSetURL();
        $this->fnSetRefURL();   
    ...
    function fnSetMiscProperties(){
        ...
        $this->fnSetVisitorProperty('serverTime',$this->wsmGetCurrentUTCDate('Y-m-d H:i:s'));
    ...
    function fnSetFirstActionVisitTime(){
        ...
        $this->fnSetVisitorProperty('firstActionVisitTime',$this->wsmGetCurrentUTCDate('Y-m-d H:i:s'));
    }
    function fnSetVisitLastActionTime(){
        $this->fnSetVisitorProperty('visitLastActionTime',$this->wsmGetCurrentUTCDate('Y-m-d H:i:s'));
    }
    ...
    function fnGetLocalTime(){
        $localTimes = array(
            'h' => (string)$this->fnGetParam('h')?$this->fnGetParam('h'):$this->wsmGetCurrentUTCDate("H"),
            'i' => (string)$this->fnGetParam('m')?$this->fnGetParam('m'):$this->wsmGetCurrentUTCDate("i"),
            's' => (string)$this->fnGetParam('s')?$this->fnGetParam('s'):$this->wsmGetCurrentUTCDate("s")
        );
    ...
    function wsmGetCurrentUTCDate($format = "Y-m-d H:i:s"){
        $dateTime='now';
        $timeZone=  new DateTimeZone($this->wsmGetTimeZone());
